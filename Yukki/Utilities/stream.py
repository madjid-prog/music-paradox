...
async def start_stream_audio(
    ...
    if await is_active_chat(message.chat.id):
        ...
        final_output = await message.reply_photo(
            ...
            caption=(
                f"🎬<b>__Audio:__ </b> [Diberikan Audio Melalui Telegram]({link})\n⏳<b>__Durasi:__</b> {duration_min} \n👤<b>__Di req oleh:__ </b>{message.from_user.mention} \n🚧<b>__Antrian ke:__</b> <b>#{position}!</b>"
            ),
        ...
        await mystic.delete()
        cap = f"🎥<b>__Memutar:__ </b>[Diberikan Audio Melalui Telegram]({link})\n👤**__Di req oleh:__** {message.from_user.mention}"
        final_output = await message.reply_photo(
            photo="Utils/Telegram.JPEG",
            reply_markup=InlineKeyboardMarkup(buttons),
            caption=cap,
